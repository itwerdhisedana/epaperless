...
if(isset($_SESSION['atra_id']) AND isset($_SESSION['atra_pass'])){
	...
	<html lang="en">
		<head>
			...
			<meta charset="utf-8" />
			<title>Sistem Informasi Naskah Dinas - SI-Nadin</title>
						...
						if($HakAkses->sm == "R"){?>
							<li class="<?php echo $StatArsipSM;?>">
								<a href="./index.php?op=arsip_sm">
									<i class="menu-icon fa fa-inbox"></i>
									<span class="menu-text"> Arsip Nadin Masuk</span>
								</a>
								<b class="arrow"></b>
							</li><?php
						}
						...
						if($HakAkses->sk == "R"){?>
							<li class="<?php echo $StatArsipSK;?>">
								<a href="./index.php?op=arsip_sk">
									...
									<span class="menu-text"> Arsip Nadin Keluar</span>
								</a>
								<b class="arrow"></b>
							</li><?php
						}
								...
								if($HakAkses->atur_klasifikasi_sm == "Y"){?>
									<li class="<?php echo $StatKlasSM;?>">
										<a href="./index.php?op=klasifikasi">
											<i class="menu-icon fa fa-tags"></i>
											<span class="menu-text"> Klasifikasi Nadin Masuk </span>
										</a>
										<b class="arrow"></b>
									</li><?php
								}
								if($HakAkses->atur_klasifikasi_sk == "Y"){?>
									<li class="<?php echo $StatKlasSK;?>">
										<a href="./index.php?op=klasifikasi_sk">
											<i class="menu-icon fa fa-tags"></i>
											<span class="menu-text"> Klasifikasi Nadin Keluar </span>
										</a>
										<b class="arrow"></b>
									</li><?php
								}
										...
										//if(($_SESSION['hakakses'] == "Sekretaris") || ($_SESSION['hakakses'] == "Manager")){?>
											<div class="row">
												...
												<div class="alert alert-block alert-success">
													...
													Selamat datang di Aplikasi (SI-Nadin).
												</div>
												<center><?php
													if($HakAkses->sm == "W" OR $HakAkses->sm == "R"){?>
													<a href="./index.php?op=sm">
					...
					<div class="footer-inner">
						<div class="footer-content">
							<span class="bigger-120">
								<span class="blue bolder">Sistem Informasi Naskah Dinas (SI-Nadin) - Baliartsys</span>
